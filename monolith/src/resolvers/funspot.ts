...
export const funspotResolvers = {
  Query: {
    getOneFunspotById: async (_: any, { funspotId }: any) => {
      try {
    ...
    getAllFunspotsByCustomerID: async (_: any, { customerId }: any) => {
      try {
  ...
  Mutation: {
    // funspots crud
    //-----------------------------------------------
    createFunspot: async (_: any, { input }: any) => {
      try {
    ...
    updateFunspot: async (_: any, { funspotId, input }: any) => {
      try {
