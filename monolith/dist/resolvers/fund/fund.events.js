...
export const publishFundCreated = (fund) => {
    if (pubsub) {
...
export const publishFundUpdated = (fund) => {
    if (pubsub) {
...
export const publishFundDeleted = (fund) => {
...
export const getFundCreatedAsyncIterator = () => {
    if (!pubsub)
        throw new Error("PubSub not available for subscriptions.");
