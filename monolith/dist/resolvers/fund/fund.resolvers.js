...
export const fundsResolvers = {
    ...
    Mutation: {
        createFund: async (_, args, context // Assuming pubsub might still be needed from context for some reason, though events.ts now imports it
        ) => {
        ...
        updateFund: async (_, { fundId, fund: fundData }, context) => {
        ...
        deleteFund: async (_, { fundId }, context) => {
            try {
