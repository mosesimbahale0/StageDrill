...
export default function CameraControl() {
  ...
  return (
    <div className=" flex flex-col items-center text-text2">
      <div className="flex flex-col gap-2 justify-left items-center  py-2  rounded-lg  w-full">
        <div className="rounded-xl p-4 h-48 w-64 fixed right-2 bottom-24 flex justify-center items-center">
        ...
        <button
          className={`bg-accent text-text py-4 px-8  hover:bg-complementary flex flex-row gap-4 justify-center items-center ${
            isCameraOn
              ? "bg-accent hover:bg-complementary rounded-full"
              : "bg-danger hover:bg-danger/80 rounded-2xl"
          }`}
