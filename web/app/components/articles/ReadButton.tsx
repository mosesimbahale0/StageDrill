...
export default function Read() {
  return (
    <>
      <button className="bg-quaternary shadow hover:bg-accent text-text px-4 h-12 rounded-full flex flex-row gap-2 justify-center items-center border-2 border-quaternary hover:border-2  hover:border-accent text-sm">
